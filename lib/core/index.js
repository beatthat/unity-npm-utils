...
const copyFromUnity2Pkg = (unityProjectRoot, pkgName, options, callback) => {
    ...
    const promise = new Promise((resolve, reject) => {
        ...
        .then(info => {
            ...
            console.log('copyFromUnity2Pkg...pkgRoot=%j, info=%j', pkgRoot, info);
            ...
            const copy = () => {
                ...
                console.log('copyFromUnity2Pkg...inside copy');
