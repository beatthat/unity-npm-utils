...
const writePackageInfoToUnpmLocal = require('./write-package-info-to-unpm-local.js');

const installPackageToUnity = require('./install-package-to-unity')

const deepCopy = require('./deep-copy.js');
const readUnpmLocal = require('./read-unpm-local.js');
...
const modCloneOrPull = require('../git/clone-or-pull-installed-package.js');
const modCloneLink = require('../git/link-package-2-clone.js');
...
module.exports = {
    ...
    installPackageToUnity: installPackageToUnity,
    deepCopy: deepCopy,
    readPackage: readPackage,
    writePackageInfoToUnpmLocal: writePackageInfoToUnpmLocal,
    readUnpmLocal: readUnpmLocal,
