...
const findRepoInfoForPackage = async (packageName, opts) => {
    ...
    const mf = new MessageFormat('en').compile(scopeInfo.repository)

    console.log(`typeof MessageFormat=${typeof(MessageFormat)}`)
    console.log(`typeof new MessageFormat('en')=${typeof(new MessageFormat('en'))}`)
    console.log(`typeof new MessageFormat('en').compile=${typeof(new MessageFormat('en').compile(scopeInfo.repository))}`)
    
    return mf({package_name: packageName})
}
