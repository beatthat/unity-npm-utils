...
const moduleUpdateWorkingCopy = (moduleRoot, options, callback) => {
    ...
    const promise = new Promise((resolve, reject) => {
        ...
        console.log('wcDir=%j', wcDir);

        mkdirp(wcDir, (mkdirErr) => {
            if (mkdirErr) {
                console.log('failed to create working-copy dir %j', wcDir);
            ...
            cloneOrPull(pkgUrl, gitOpts, (gitErr) => {
                ...
                console.log('failed to update working-copy for %j with opts %j', pkgUrl, gitOpts);
