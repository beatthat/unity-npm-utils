                    ...
                    templateReq.on('end', () => {
                        ...
                        fs.createReadStream(tmpArchive)
                            ...
                            .on('close', () => {
                                ...
                                // console.log('unzipped to %j', tmpDirPath);
...
const unityPackage_incrementVersion = (pkg, options, callback) => {
    ...
    const promise = new Promise((resolve, reject) => {
        ...
        if(isPath) {
            ...
            // console.log('inside unityPackage_incrementVersion recursion of unityPackage_incrementVersion=' + typeof(unityPackage_incrementVersion));
